...
class ImageReaderBase(ScreenBase, TypingHelperBase, PositionHelperBase):
    """
...
""") % {
    ...
    class FileScannerThread(Thread):
        ...
        def run(self):
            ...
            """
            ImageReaderBase.recursively_populate_queue(self.__file_reader_instance, self.__queue_of_valid_files, self.__path_to_scan)
